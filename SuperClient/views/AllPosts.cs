    ...
    public partial class AllPosts : Form, IAllPostsView
    {
        ...
        public void UpdateLikeButton(Button btnLike, Post post)
        {
            ...
            if (post.IsLiked)
            {
                ...
                btnLike.Image = ResizeImage(Image.FromFile("C:/Users/Ирина/OneDrive/Рабочий стол/клон/SuperProject/SuperClient/Resources/red_heart.png"), 20, 20);
            }
            else
            {
                btnLike.BackColor = Color.White; // Белый цвет, если пост не лайкнут
                btnLike.Image = ResizeImage(Image.FromFile("C:/Users/Ирина/OneDrive/Рабочий стол/клон/SuperProject/SuperClient/Resources/black_heart.png"), 20, 20);
            }
        }
